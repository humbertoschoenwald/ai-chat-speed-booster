...
export function createExtensionStatus(input: ContentStatusPresenterInput): ExtensionStatus {
    ...
    return {
        ...
        nativeModeRoleSourceCounts: chatGpt?.nativeMessageMetadata?.roleSourceCounts,
        nativeModeRoleConfidenceCounts: chatGpt?.nativeMessageMetadata?.roleConfidenceCounts,
        nativeModeUnknownRoleCount: chatGpt?.nativeMessageMetadata?.unknownRoleCount,
        ...
        nativeModeLayoutBatchPending: chatGpt?.nativeLayoutChangeBatch?.pending,
        nativeModeLayoutBatchChangeCount: chatGpt?.nativeLayoutChangeBatch?.changeCount,
        nativeModeLayoutBatchMeasuredTurnCount: chatGpt?.nativeLayoutChangeBatch?.measuredTurnCount,
        nativeModeLayoutBatchSkippedCachedOldTurnCount: chatGpt?.nativeLayoutChangeBatch?.skippedCachedOldTurnCount,
        nativeModeLayoutBatchProtectedTailSize: chatGpt?.nativeLayoutChangeBatch?.protectedTailSize,
        nativeModeLayoutBatchLastReason: chatGpt?.nativeLayoutChangeBatch?.lastReason,
        ...
        nativeModeAnchoredMenuDocumentCount: chatGpt?.nativeScopedDiagnostics?.anchoredMenus.documentRelationshipCount,
